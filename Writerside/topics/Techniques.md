...
- [Introduce Foreign Method](https://refactoring.guru/ko/introduce-foreign-method)
- [Introduce Local Extension](https://refactoring.guru/ko/introduce-local-extension)
- 외부 API, 라이브러리 등을 사용할 때 직접 사용하지 말고 Wrapper를 만들어서 사용
